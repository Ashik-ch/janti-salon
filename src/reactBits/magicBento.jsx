...
const cardData = [
    ...
    },
    {
        ...
        img: "https://img.freepik.com/free-photo/man-barbershop-salon-doing-haircut-beard-trim_1303-20965.jpg?uid=R209241097&ga=GA1.1.136895706.1708360816&semt=ais_incoming&w=740&q=80",
    },
    {
        title: "Facial Treatments",
        description: "Advanced facial therapies for radiant, youthful skin.",
        img: "https://via.placeholder.com/600x400?text=Facial+Treatments",
    },
    {
        title: "Makeup Artistry",
        description: "From natural enhancements to glamorous transformations for any occasion.",
                            ...
                            >
                                ...
                                >
                                    <div className="relative w-full h-48 sm:h-56 overflow-hidden">
                                        <img
                                            src={card.img || "https://i0.wp.com/bekkybarber.com/ae/wp-content/uploads/sites/2/2025/05/handsome-man-cutting-beard-barber-shop-salon-1.jpg?fit=1200%2C800&ssl=1"}
                                            alt={card.title}
                                    ...
                                    <div className="relative p-6 text-center flex-grow flex flex-col justify-between">
                                        <h3 className="text-2xl font-bold text-primary mb-3 group-hover:text-white transition-colors duration-300">{card.title}</h3>
